      ...
      <div className="container-x">
        ...
        >
          ...
          <div className="relative">
            <span className="text-xs font-bold uppercase tracking-[0.2em] text-lime-400">Ready when you are</span>
            <h2 className="mx-auto mt-4 max-w-2xl font-display text-4xl font-medium leading-[1.05] md:text-6xl">
              Upgrade your <span className="italic text-lime-400">procurement</span> today.
            </h2>
            <p className="mx-auto mt-5 max-w-xl text-cream/70">
              Join hundreds of restaurants, cafes and hotels that trust Hyperpure for fresher supply, better prices and on-time delivery.
            </p>
